// seed-firebase.js — run once to load your ingested data into Firestore
const firebase = require('firebase/compat/app');
require('firebase/compat/firestore');

const firebaseConfig = {
  // PASTE YOUR NEW CONFIG FROM THE NEW PROJECT HERE
  apiKey: "AIzaSy...NEW_KEY_FROM_NEW_PROJECT...",
  ...
  appId: "1:NEW_APP_ID:web:NEW_WEB_ID"
};
